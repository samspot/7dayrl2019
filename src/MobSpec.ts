...
const abilities: { [key: string]: Array<Object> } = {
    ...
    'Ada Wong': [EmptySlot, EmptySlot],
    'Rebecca Chambers': [EmptySlot, EmptySlot],
    'William Birkin': [EmptySlot, EmptySlot],
    'Hunk': [EmptySlot, EmptySlot],
    'Krauser': [EmptySlot, EmptySlot],
    'Billy Coen': [EmptySlot, EmptySlot],
