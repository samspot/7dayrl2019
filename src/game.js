...
catacombs not connecting 100% of the time  :(
...
X. Remaining boss portraits
X. make mobs able to use, tick their abilities
...
export class Game {
    ...
    generateMap(mapspec) {
        ...
        if (mapspec._iterations) {
            ...
            // TODO Pass value?  defaults to 0, but what does it mean in my project.   maybe '.' ? https://github.com/ondras/rot.js/blob/ab046a2/src/map/cellular.ts#L13
            generator.connect(x => { console.log('connect cb', x) })
        } else {
